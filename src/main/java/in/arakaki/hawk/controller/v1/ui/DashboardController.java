package in.arakaki.hawk.controller.v1.ui;

import in.arakaki.hawk.controller.v1.command.*;
import in.arakaki.hawk.dto.model.bus.AgencyDto;
import in.arakaki.hawk.dto.model.bus.TweetsDto;
import in.arakaki.hawk.dto.model.bus.StopDto;
    ...
    public ModelAndView addNewBus(@Valid @ModelAttribute("busFormData") BusFormCommand busFormCommand, BindingResult bindingResult) {
        ...
        if (!bindingResult.hasErrors()) {
            try {
                ...
                AgencyDto updatedAgencyDto = busReservationService.updateAgency(agencyDto, TweetsDto);
